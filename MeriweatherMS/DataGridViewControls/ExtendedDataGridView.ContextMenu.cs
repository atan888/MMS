...
namespace DataGridViewControls
{
    partial class ExtendedDataGridView
    {
        ...
        void MenuOpening(object sender, CancelEventArgs e)
        {
            ...
            /*  Comment out the menu system
            //add excell menu
            ToolStripMenuItem toolMenu = CreateExportMenuItem(true);
            if (toolMenu != null) menuColumnHeader.Items.Add(toolMenu);
            //add cvs menu
            toolMenu = CreateExportMenuItem(false);
            if (toolMenu != null) menuColumnHeader.Items.Add(toolMenu);
            */
        ...
        ToolStripMenuItem CreateExportMenuItem(bool bExcel)
        {
            if (bExcel)
            {
